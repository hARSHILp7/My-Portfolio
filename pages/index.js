  ...
  return (
    <div className='bg-[#F0F2F2] tracking-wider'>
      ...
      <div className="sticky top-0 left-0 font-mono font-bold bg-[#393E59] text-[#F0F2F2] tracking-normal">
        <ul className="flex flex-col max-w-[85%] mx-auto justify-evenly text-center py-4 text-lg md:flex-row md:max-w-[80%]">
      ...
      <div className="text-center bg-[#393E59] text-[#F0F2F2] font-mono" id="ContactMe">
        <div className="py-6">
          ...
          <ul className="flex flex-col justify-between max-w-[50%] mx-auto md:flex-row">
